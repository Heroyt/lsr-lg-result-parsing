...
class Scoring implements InsertExtendInterface
{
    ...
    public static function parseRow(Row $row): static
    {
        ...
        /** @phpstan-ignore cast.int */
            ...
            /** @phpstan-ignore cast.int */
            EncouragementBonus::tryFrom((int)($row->scoring_encouragement_bonus ?? 0)) ?? EncouragementBonus::OFF,
            /** @phpstan-ignore cast.int */
            (int)($row->scoring_encouragement_bonus_score ?? 0),
            /** @phpstan-ignore cast.int */
            (int)($row->scoring_power ?? 0),
            /** @phpstan-ignore cast.int */
            (int)($row->scoring_penalty ?? 0),
            /** @phpstan-ignore cast.int */
            (int)($row->scoring_activity ?? 0),
            /** @phpstan-ignore cast.int */
            (int)($row->scoring_knockout ?? 0),
        );
    }
